  ...
  <li>
    ...
    >
      ...
      <div className="results-item__info">
        ...
        <div className="results-item__line results-item__line--description">
          <span className="description-item">{restaurant.food_type}</span>
          <span className="description-pipe"> | </span>
          <span className="description-item">{restaurant.neighborhood}</span>
          <span className="description-pipe"> | </span>
          <span className="description-item">{restaurant.price_range}</span>
        </div>
      </div>
    </a>
  </li>
